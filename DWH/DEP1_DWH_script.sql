...
CREATE TABLE [dbo].[FactWeather] (
    ...
    [PrecipQuantity] DECIMAL,
    [TempAvg] DECIMAL,
    [TempMax] DECIMAL,
    [TempMin] DECIMAL,
    [TempGrassPt100Avg] DECIMAL,
    [TempSoilAvg] DECIMAL,
    [TempSoilAvg5cm] DECIMAL,
    [TempSoilAvg10cm] DECIMAL,
    [TempSoilAvg20cm] DECIMAL,
    [TempSoilAvg50cm] DECIMAL,
    [WindSpeed10m] DECIMAL,
    [WindSpeedAvg30m] DECIMAL,
    [WindGustsSpeed] DECIMAL,
    [HumidityRelShelterAvg] DECIMAL,
    [Pressure] DECIMAL,
    [SunDuration] DECIMAL,
    [ShortWaveFromSkyAvg] DECIMAL,
    [SunIntAvg] DECIMAL
);
