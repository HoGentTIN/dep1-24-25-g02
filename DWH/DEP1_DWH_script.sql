...
CREATE TABLE [dbo].[FactWeather] (
    ...
    [PrecipQuantity] DECIMAL(7,2),
    [TempAvg] DECIMAL(7,2),
    [TempMax] DECIMAL(7,2),
    [TempMin] DECIMAL(7,2),
    [TempGrassPt100Avg] DECIMAL(7,2),
    [TempSoilAvg] DECIMAL(7,2),
    [TempSoilAvg5cm] DECIMAL(7,2),
    [TempSoilAvg10cm] DECIMAL(7,2),
    [TempSoilAvg20cm] DECIMAL(7,2),
    [TempSoilAvg50cm] DECIMAL(7,2),
    [WindSpeed10m] DECIMAL(7,2),
    [WindSpeedAvg30m] DECIMAL(7,2),
    [WindGustsSpeed] DECIMAL(7,2),
    [HumidityRelShelterAvg] DECIMAL(7,2),
    [Pressure] DECIMAL(7,2),
    [SunDuration] DECIMAL(7,2),
    [ShortWaveFromSkyAvg] DECIMAL(7,2),
    [SunIntAvg] DECIMAL(7,2)
);
